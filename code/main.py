...
while iterations < args.runs:
    ...
    token = '{}_sl{}_max{}_list{}_attn{}'.format(model_name, args.seq_len, int(args.maxpool), int(args.use_lstm),
                                                 str(args.attn))
    ...
    evaluate(valid_loader, valid_dataset_loader, set_name='Valid')
